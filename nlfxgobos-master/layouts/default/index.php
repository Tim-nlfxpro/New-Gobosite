...
<body>
  <div id="main">
    <div id="header">
      ...
      <h1 style="font-family: 'Old Republic', cursive; font-size: 72px; text-decoration: none;">Custom GOBOS</h1>
      </div>
        <?php /*
    ...
    <div id="site_content">
      <div class="sidebar">
        ...
        <!--Begin ClixTrac.com Rotator Code -->
						<script type="text/javascript" language="javascript" src="http://www.clixtrac.com/rotate/1707"></script>
						<p>     <a href="http://media.nlfxpro.com/NLFXImg new.pdf"><img src="docroot/images/GOBPDF.png" alt="" height="32" width="32" border="0"></a>	
		<!--End ClixTrac.com Rotator Code --></p>
					</center>
